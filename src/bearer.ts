 ...
 * unico escritor del volumen de los slots— tambien lo necesito: una segunda
 * copia de una comparacion timing-safe es una copia que alguien va a
 * "simplificar" a `===`.
 */
export function isTokenValid(header: string | undefined, expected: string): boolean {
